...
CHyperLink::CHyperLink() : m_bOverControl(FALSE), m_bVisited(FALSE), m_bLinkActive(FALSE)
{
...
void CHyperLink::SetColors(COLORREF crLinkColor, COLORREF crActiveColor, COLORREF crVisitedColor, COLORREF crHoverColor) 
{
