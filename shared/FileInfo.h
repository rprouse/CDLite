...
#ifndef ALTERIDEM_FILEINFO_H
#define ALTERIDEM_FILEINFO_H
...
/**
 * @class CFileInfo
 * Stores information about a file in a way like <c CFindFile> does
 */
class CFileInfo {  
public:
 ...
 * Allows to retrieve <c CFileInfo>s from files/directories in a directory
 */
